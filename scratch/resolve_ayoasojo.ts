...
dotenv.config({ path: path.join(__dirname, '../nicwebportal/.env.local') })
...
async function resolveUser() {
  ...
  if (!targetAuthUser) {
    ...
    console.log(`  - App Metadata:`, targetAuthUser.app_metadata)
    console.log(`  - User Metadata:`, targetAuthUser.user_metadata)
    console.log(`  - Banned / Suspended:`, (targetAuthUser as any).banned_until || 'No')
