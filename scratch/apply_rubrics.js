...
// ─────────────────────────────────────────────────────────────────────────────
// NIC GRADING RUBRICS — one per module topic
// These rubrics guide the AI examiner on what to look for in essay responses.
// Shared across all courses that include the module (by design of the LMS).
// ─────────────────────────────────────────────────────────────────────────────
const RUBRICS = {

  "INTRODUCTION TO PROFESSIONAL CAREGIVING": `
NIC Professional Caregiving Standards — Rubric
...
NIC Ethics & Dignity Standards — Rubric
...
NIC Communication Standards — Rubric

CONTEXT: Effective communication is a core clinical safety skill, not a soft skill. This module covers verbal, non-verbal, and written communication; structured reporting (SBAR, SOAP); family and interprofessional communication; and managing difficult conversations. Particular attention is paid to communicating with clients who have disabilities, cognitive impairment, or language barriers in Nigerian settings.
...
NIC ADL & Personal Care Standards — Rubric
...
NIC Safe Mobility & Positioning Standards — Rubric

CONTEXT: This module covers safe patient handling: bed mobility, transfer techniques (bed-to-chair, chair-to-toilet), repositioning schedules, fall prevention, and emergency response to falls. Includes pressure injury staging and prevention. Students are expected to apply biomechanical principles and adapt to Nigerian environments without specialised hoisting equipment.

SCORING GUIDE:
▸ EXCELLENT (90–100%): Student correctly describes body mechanics for safe lifting/transfer, explains the 2-hourly repositioning rule for immobile patients, identifies pressure injury risk sites and prevention strategies. Demonstrates a structured fall-response protocol (do not move, assess, call for help, document). Adapts techniques to environments without hoists or specialised equipment. Identifies when to escalate.
...
NIC Infection Control & Hygiene Standards — Rubric

CONTEXT: This module covers hand hygiene (WHO 5 Moments), PPE use and disposal, environmental cleaning, waste management, and infection control in resource-limited Nigerian homes (erratic water supply, limited PPE, shared spaces). Students must demonstrate that infection prevention is both a clinical and an environmental discipline.
...
▸ UNSATISFACTORY (0–49%): Incorrect or absent hand hygiene steps. PPE misused or doffing sequence wrong. No awareness of cross-infection risks. Student responses would create rather than reduce infection risk.
...
NIC Health Monitoring & Medication Awareness Standards — Rubric

CONTEXT: This module covers vital sign monitoring, medication awareness (not administration), recognising medication side effects, polypharmacy risks, and knowing when and how to escalate health concerns to clinical professionals. The caregiver's role is observation and facilitation — never prescription or injection.

SCORING GUIDE:
▸ EXCELLENT (90–100%): Student correctly identifies normal ranges for all five vital signs (temperature, pulse, respiration, BP, SpO2) and can describe what deviations indicate. Articulates the caregiver's role in medication: reminder, observation of effect, and reporting — never administering without instruction or touching controlled drugs. Correctly identifies at least three red flags for escalation (e.g., BP >180/120, RR >24, SpO2 <90%). Uses SBAR for escalation scenario. Demonstrates awareness of polypharmacy and drug-herb interactions in Nigeria.
...
▸ SATISFACTORY (50–69%): Basic vital sign awareness. Medication role understood at surface level (no prescribing) but lacks detail. Escalation triggers vague. No polypharmacy awareness.
...
NIC Emergency Response & Incident Reporting Standards — Rubric

CONTEXT: This module covers recognition and first-line response to medical emergencies (stroke, hypoglycaemia, seizures, cardiac events, respiratory distress), fall management, incident documentation, and legal reporting obligations. Students must demonstrate they can act safely and decisively within their scope while coordinating with emergency services under Nigerian infrastructure constraints.
...
▸ UNSATISFACTORY (0–49%): Incorrect or dangerous emergency response (e.g., giving food to an unconscious patient, moving a patient after a fall without assessment). No incident documentation skills. Scope of practice violated.

KEY COMPETENCIES TO ASSESS:
1. FAST acronym for stroke (Face drooping, Arm weakness, Speech difficulty, Time to call)?
2. Correct hypoglycaemia management: conscious patient → oral glucose; unconscious → do NOT give anything by mouth, escalate immediately?
...
NIC Safeguarding & Client Rights Standards — Rubric

CONTEXT: This module covers recognising, responding to, and reporting all forms of abuse and neglect (physical, emotional, sexual, financial, organisational, self-neglect). It covers client rights, whistleblowing, safeguarding cultures, and the unique challenges of reporting abuse within Nigerian family and community structures where the abuser is often a trusted family member.
...
▸ UNSATISFACTORY (0–49%): Abuse types confused or incomplete. Reporting absent or delayed ("wait and see"). Student would keep information from supervisors. Client rights not addressed.
...
NIC Disability & Inclusive Care Standards — Rubric

CONTEXT: This module introduces the social model of disability, disability rights in Nigeria, inclusive care principles, and the ethical obligations of a caregiver working with persons with physical, intellectual, or sensory disabilities. Emphasis on empowerment over dependency, and dignity as a non-negotiable standard.
...
▸ UNSATISFACTORY (0–49%): Disability viewed only through a charitable or medical lens. No rights framework. Care described in ways that disempower the client. Stereotyping or ableist assumptions present.
...
3. Is person-first language used (person with a disability, not "disabled person" or "the blind one")?
...
NIC Person-Centred Care Standards (Disability) — Rubric

CONTEXT: This module focuses on developing individualised care plans for people with disabilities, working collaboratively with families and care teams, and ensuring the client's voice remains central to all care decisions — even when family or institutional pressures push toward a standardised or paternalistic approach.
...
▸ GOOD (70–89%): Care plan elements understood (goals, activities, review). Person-centred principles applied. Family collaboration described but client primacy may not be consistently maintained. Documentation mentioned.
▸ SATISFACTORY (50–69%): Care plan concepts present but generic. Person-centred language used but not applied to specific scenarios. Family and team roles unclear. Documentation not addressed.
...
NIC Physical Disability Support Standards — Rubric

CONTEXT: This module covers safe support for clients with physical disabilities including hemiplegia, paraplegia, limb differences, and degenerative conditions. Topics include adaptive equipment, pressure injury prevention for wheelchair users, supporting rehabilitation exercises, and preventing secondary complications (contractures, DVT, UTIs in catheterised patients).

SCORING GUIDE:
▸ EXCELLENT (90–100%): Student demonstrates knowledge of adaptive equipment (wheelchair, hoists, grab rails, adaptive utensils) and when each applies. Correctly describes pressure injury prevention for wheelchair users (pressure relief every 15–30 mins). Shows awareness of secondary complication prevention (range-of-motion exercises, hydration for UTI prevention, compression for DVT risk). Adapts support to the Nigerian home context without specialist equipment. Knows when physical therapy instructions take precedence.
...
▸ SATISFACTORY (50–69%): Basic physical disability support described. Pressure injury prevention superficial. Secondary complications not addressed. No adaptation to resource-limited settings.
...
NIC Intellectual & Developmental Disability Support Standards — Rubric

CONTEXT: This module covers care for individuals with intellectual disabilities (ID), autism spectrum conditions (ASC), Down syndrome, and other developmental conditions. Focus areas: communication adaptations (AAC, visual schedules, simplified language), behavioural support (positive behaviour support, de-escalation, safe restraint avoidance), daily skills support, and the dignity and rights of adults with IDD.

SCORING GUIDE:
▸ EXCELLENT (90–100%): Student demonstrates communication adaptations appropriate to IDD (simple sentences, visual aids, AAC symbols, consistent routines). Correctly describes positive behaviour support (PBS) principles — understanding the function of behaviour before responding. Shows de-escalation techniques and explicitly states physical restraint is a last resort requiring authorisation. Promotes daily skills development (not doing for the client). Addresses consent and capacity for adults with IDD in Nigeria.
▸ GOOD (70–89%): Communication adaptations present and appropriate. PBS principles mentioned. De-escalation described. Restraint caution stated. Skill development partially addressed.
▸ SATISFACTORY (50–69%): Basic communication adjustments mentioned. Behaviour treated reactively rather than proactively. Restraint not explicitly addressed. Limited skills development focus.
...
2. Is behaviour understood as communication (the student asks "what is the behaviour communicating?" before responding)?
3. Is physical restraint identified as a serious last resort requiring specific authorisation — never used as a first response?
4. Does the student describe at least one strategy for supporting daily living skill development (task analysis, prompting, celebration of progress)?
5. Are the rights and capacity of adults with IDD respected (they are not "eternal children")?
...
NIC Sensory Disability & Communication Standards — Rubric

CONTEXT: This module covers care for clients with visual, hearing, or combined sensory impairments. Topics include environmental orientation, safe guiding techniques for blind clients, communication strategies for Deaf and hard-of-hearing clients, reducing isolation, and adapting daily care to sensory needs.

SCORING GUIDE:
▸ EXCELLENT (90–100%): Student correctly describes the sighted guide technique (client holds caregiver's arm, not the reverse). Demonstrates environmental orientation strategies for visually impaired clients (clock-face plate descriptions, consistent room layout, verbal narration). Shows communication adaptations for hearing-impaired clients (face client, speak clearly, use written notes, lipreading support). Identifies the risk of social isolation in sensory disability and proposes specific inclusion strategies. Adapts all techniques to Nigerian home environments.
▸ GOOD (70–89%): Sighted guide technique and hearing communication adaptations correct. Orientation strategies present. Isolation risk acknowledged. Nigerian adaptation partial.
▸ SATISFACTORY (50–69%): Basic awareness of visual and hearing disability. Sighted guide technique may be incorrect (leading by the hand). Communication adaptations generic. Isolation not addressed.
...
NIC Advanced Safeguarding & Advocacy Standards — Rubric

CONTEXT: This module covers the caregiver's advocacy role, professional boundaries under pressure, documentation and reporting responsibilities, managing caregiver stress and burnout, and maintaining professional resilience. Students are expected to demonstrate understanding that advocacy sometimes means respectfully challenging family members, employers, or cultural norms in defence of client rights.

SCORING GUIDE:
▸ EXCELLENT (90–100%): Student articulates the caregiver as a client advocate — not a family agent or passive task executor. Demonstrates how to respectfully challenge unsafe instructions from family elders using evidence-based communication. Correctly describes documentation responsibilities (objective, contemporaneous, signed). Shows understanding of professional resilience strategies and NIC's support pathways for caregiver stress. Demonstrates that professional responsibility includes self-reporting concerns to supervisors even when uncomfortable.
▸ GOOD (70–89%): Advocacy role understood. Documentation responsibilities correct. Challenging unsafe instructions addressed. Resilience strategies present. May lack specific communication scripts for advocacy conversations.
▸ SATISFACTORY (50–69%): Advocacy acknowledged but applied passively ("I would inform the family"). Documentation mentioned. Stress management surface-level. Professional reporting limited.
▸ UNSATISFACTORY (0–49%): Caregiver role described as purely task-based or subordinate to family instructions. Documentation not addressed as a professional duty. No understanding of advocacy or self-care as professional responsibilities.
...
5. Does the student identify their duty to report concerns up the chain (supervisor, NIC) rather than resolve them alone?
`,

  "DOCUMENTATION, SELF-CARE & CAREER DEVELOPMENT": `
NIC Documentation, Self-Care & Career Development Standards — Rubric

CONTEXT: This module covers accurate care record keeping, the legal status of care documentation, professional self-care to prevent burnout, and NIC career pathway progression (Levels 1–5). Students must demonstrate that documentation is a clinical safety tool, not a bureaucratic chore, and that sustainable caregiving requires intentional self-management.

SCORING GUIDE:
▸ EXCELLENT (90–100%): Student demonstrates correct documentation standards (SOAP or equivalent: objective, factual, dated, signed). Articulates the legal weight of care records and the risk of incomplete documentation (clinical risk, professional liability). Proposes at least three specific self-care strategies (peer support, scheduled rest, boundary setting, debriefing, supervision). Maps their own NIC career pathway and articulates what advancement at the next level requires. Shows understanding of CPD requirements.
▸ GOOD (70–89%): Documentation standards correct. Legal risk of poor records mentioned. Self-care strategies identified (may be generic). Career pathway awareness present. CPD mentioned.
▸ SATISFACTORY (50–69%): Documentation described but standards incomplete (e.g., no mention of objectivity or signatures). Self-care surface-level. Career pathway vague. CPD not connected to practice.
▸ UNSATISFACTORY (0–49%): Documentation described as optional or minimal. Self-care not addressed as a professional responsibility. No career development awareness.
...
// ─────────────────────────────────────────────────────────────────────────────
async function main() {
    console.log('Fetching assessments with essay questions and no rubric...\n');

    // Get all assessments needing rubrics, with module info via lesson join
    ...
    console.log(`Found ${needsRubric.length} assessments needing rubrics.\n`);
    ...
    for (const a of needsRubric) {
        ...
        // Find matching rubric (case-insensitive, partial match)
        let rubric = null;
        for (const [key, val] of Object.entries(RUBRICS)) {
            if (moduleTitle && moduleTitle.includes(key.toUpperCase())) {
                rubric = val.trim();
                break;
            }
        }
        ...
        if (!rubric) {
            skipped++;
            skippedList.push({ id: a.id, title: a.title, moduleTitle });
            continue;
        }

        const { error: updateError } = await sb
            .from('assessments')
            .update({ grading_rubric: rubric })
            .eq('id', a.id);

        if (updateError) {
            console.error(`  ✗ Failed: ${a.title}`, updateError.message);
        } else {
            updated++;
            console.log(`  ✓ Updated: [${moduleTitle?.substring(0,40)}] ${a.title}`);
        }
    }
    ...
    if (skippedList.length) {
        console.log('\n  SKIPPED (no matching rubric):');
        skippedList.forEach(s => console.log(`    - [${s.moduleTitle}] ${s.title}`));
    }
    console.log(`═══════════════════════════════════════`);
}
