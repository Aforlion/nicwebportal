...
export default function InspectionsClient({ initialFacilities, stats }: InspectionsClientProps) {
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid gap-6 md:grid-cols-4">
                ...
                <Card>
                    <CardContent className="p-6">
                        <p className="text-xs font-bold text-destructive uppercase tracking-widest">Scantioned</p>
                        <div className="text-2xl font-bold text-secondary mt-1">{stats.critical}</div>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="relative">
                ...
                <Input
                    placeholder="Search facilities by name, registration ID, or location..."
