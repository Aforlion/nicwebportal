...
const programs = [
    ...
    },
    {
        ...
        description: "Advanced training for caring for patients with Alzheimer's and other forms of dementia.",
        duration: "6 Weeks",
        mode: "Online + Physical",
        price: "₦50,000",
        features: ["Specialized Skills", "Case Studies", "Digital Toolkit"],
        category: "Specialty",
    },
    {
        id: "elderly",
        title: "Elderly Care Management",
        description: "Focused on geriatric care, nutrition for the elderly, and chronic disease management.",
        duration: "8 Weeks",
        mode: "Blended",
        price: "₦60,000",
        features: ["Nutrition Guide", "Medication Safety", "NIC Certified"],
        category: "Specialty",
    },
]
